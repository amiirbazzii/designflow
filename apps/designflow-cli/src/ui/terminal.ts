...
export function usage(): string {
  return [
    ...
    "    specification reads the design and writes nothing; each exact",
    "    proposal needs your approval before anything is written.",
    "  After applied changes, the visual result may offer Improve — one",
    "  bounded correction iteration, approved exactly like any proposal",
    "  designflow feedback-loop show <parent-id>  Inspect a saved continuation",
    "  designflow feedback-loop resume <parent-id>  Resume a saved continuation",
    "  designflow feedback-loop stop <parent-id>  Stop a saved continuation",
