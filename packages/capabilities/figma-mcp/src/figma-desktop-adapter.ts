...
import { parseDesignContextFacts, parseDesignContextTree, type DesignContextNodeFacts, type DesignContextTreeNode } from "./parse-desktop-design-context";
...
function expandInstanceEvidence(
  nodes: readonly FigmaNodeSnapshot[],
